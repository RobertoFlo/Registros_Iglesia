...
class ConfirmaPolicy
{
    ...
    {
        return $user->can('confirma.create');
        //
    }
    ...
    {
        return $user->can('confirma.update');
        //
    }
    ...
    {
        return $user->can('confirma.delete');
        //
    }
    ...
    {
        return $user->can('confirma.restore');
        //
    }
